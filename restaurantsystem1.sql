...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2020 at 06:51 PM
...
INSERT INTO `item` (`ID`, `ItemNumber`, `ItemName`, `Type`, `Quantity`, `MFD`, `PDate`, `EXP`, `Price`, `Supplier`) VALUES
(4, 'Item-33254', 'Rice', 'Solid', '50kg', '03/10/2020', '15/10/2020', '07/10/2020', '5000/=', 'Araliya');
...
(21, 'yasith', '20', 'Whisky', '20000'),
(22, 'lion', '200', 'Beer', '23'),
(23, 'vodka', '10000', 'Whisky', '32');
...
(1, 'Avarcado', 'Drinks', 'Avarcardo,Vanila,Suger,Milkpowder'),
(2, 'EGG RICE', 'Rice', 'Onion,Garlic,Eggs');
...
--
ALTER TABLE `billinventory`
  MODIFY `billItemCount` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `feedbackorg`
  MODIFY `FeedIDorg` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `review`
  MODIFY `ReviewID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
